...
# WARNING: PERMANENTLY DELETES ARTIFACT FILES FROM INT-TESTS, SO WILL
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        ...
        description=(
            "WARNING: PERMANENTLY DELETES ARTIFACT FILES FROM INT-TESTS, SO WILL PERMANENTLY EFFECT THINGS. DON'T USE UNLESS YOU'RE SURE WHAT YOU'RE DOING. "
            "Prints and/or deletes all job artifacts associated with jobs before given cutoff-time in int-tests repo."),
    )
